...
def template_match_best(template_img, x1=0, y1=0, x2=1280, y2=720, screen_re=None, template_threshold=0.8):
    dets = template_match_most(template_img, x1, y1, x2, y2, screen_re=screen_re, template_threshold=template_threshold)
...
# 用于模板匹配
def __template(img_gray, template_img, template_threshold):
    """
    img_gray:待检测的灰度图片格式
